...
class StorageServices {
  ...
  Future<String> uploadAttendancePhoto(
    ...
    try {
      ...
      // compress image to reduce size (important for realtime database biar ga kegedean filenya/ bottle neck)
