...
class AttendanceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (cardColor, iconColor, iconData, statusText) = _getCardStyle(
      hasCheckedIn,
      hasCheckedOut,
    ); // ini biar reusable soalnya ada 3 jenis card (not checkin, currently workin, complete)
          ...
          children: [
            ...
            if (hasCheckedIn) ...[
              ...
              if (todayRecord!.checkInPhotoPath != null ||
                  todayRecord!.checkOutPhotoPath != null)
                _buildPhotoRow(),
            ],
          ],
        ),
  ...
  (Color, Color, IconData, String) _getCardStyle(
    bool hasCheckedIn,
    bool hasCheckedOut,
  ) {
    if (!hasCheckedIn) {
